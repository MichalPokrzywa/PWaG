...
SeaShader::SeaShader() {
  ...
  const char* VERTEX_FILE = "Dependencies/include/shaders/sea.vert";
  const char* FRAGMENT_FILE = "Dependencies/include/shaders/sea.frag";
  const char* GEOMETRY_FILE = "Dependencies/include/shaders/sea.geom";
